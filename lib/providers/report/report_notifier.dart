...
class ReportNotifier extends StateNotifier<ReportState> {
  ...
  ReportNotifier({required this.addReport, required this.getReport}) : super(InitialReportState());
  ...
  Future<void> add(Report report) async {
    ...
    response.fold(
      (failure) => state = ErrorReportState("Error al agregar el reporte"),
      (reponse) => state = AddedReportState(),
    );
  }
